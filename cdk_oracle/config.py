...
class CDKConfig:
    ...
    def __post_init__(self):
        ...
        # Sync boltz2_endpoints with boltz2_url when the constructor-provided
        # URL differs from what _parse_boltz2_endpoints() resolved via env vars
        if (len(self.boltz2_endpoints) == 1 and
                self.boltz2_endpoints[0]["url"] != self.boltz2_url):
            self.boltz2_endpoints = [{
                "url": self.boltz2_url,
                "api_key": self.boltz2_api_key
            }]
